...
static const _CameraDetection_type_support_symbol_names_t _CameraDetection_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, camera_msgs, msg, CameraDetection)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, camera_msgs, msg, CameraDetection)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, camera_msgs, msg, CameraDetection)() {
  return &::camera_msgs::msg::rosidl_typesupport_c::CameraDetection_message_type_support_handle;
}
