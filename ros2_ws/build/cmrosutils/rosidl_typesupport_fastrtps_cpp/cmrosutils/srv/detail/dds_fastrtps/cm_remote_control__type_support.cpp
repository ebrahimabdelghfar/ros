...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_cmrosutils
max_serialized_size_key_CMRemoteControl_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_cmrosutils
max_serialized_size_key_CMRemoteControl_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
// functions for cmrosutils::srv::CMRemoteControl_Request already declared above

// functions for cmrosutils::srv::CMRemoteControl_Response already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_cmrosutils
cdr_serialize(
  const cmrosutils::srv::CMRemoteControl_Event & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: info
  ...
  // Member: request
  {
    ...
    for (size_t i = 0; i < size; i++) {
      cmrosutils::srv::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  cmrosutils::srv::CMRemoteControl_Event & ros_message)
{
  // Member: info
  ...
  // Member: request
  {
    ...
    for (size_t i = 0; i < size; i++) {
      cmrosutils::srv::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        cmrosutils::srv::typesupport_fastrtps_cpp::get_serialized_size(
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_cmrosutils
max_serialized_size_CMRemoteControl_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        cmrosutils::srv::typesupport_fastrtps_cpp::max_serialized_size_CMRemoteControl_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        cmrosutils::srv::typesupport_fastrtps_cpp::max_serialized_size_CMRemoteControl_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = cmrosutils::srv::CMRemoteControl_Event;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: request
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; i++) {
      cmrosutils::srv::typesupport_fastrtps_cpp::cdr_serialize_key(
        ros_message.request[i],
        cdr);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        cmrosutils::srv::typesupport_fastrtps_cpp::get_serialized_size_key(
        ros_message.request[index], current_alignment);
    }
  }
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_cmrosutils
max_serialized_size_key_CMRemoteControl_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        cmrosutils::srv::typesupport_fastrtps_cpp::max_serialized_size_key_CMRemoteControl_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        cmrosutils::srv::typesupport_fastrtps_cpp::max_serialized_size_key_CMRemoteControl_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const cmrosutils::srv::CMRemoteControl_Event *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<cmrosutils::srv::CMRemoteControl_Event *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _CMRemoteControl_Event__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const cmrosutils::srv::CMRemoteControl_Event *>(
...
static size_t _CMRemoteControl_Event__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_CMRemoteControl_Event(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _CMRemoteControl_Event__callbacks = {
  "cmrosutils::srv",
...
static rosidl_message_type_support_t _CMRemoteControl_Event__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_CMRemoteControl_Event__callbacks,
  get_message_typesupport_handle_function,
...
{
  return &cmrosutils::srv::typesupport_fastrtps_cpp::_CMRemoteControl_Event__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cmrosutils, srv, CMRemoteControl_Event)() {
  return &cmrosutils::srv::typesupport_fastrtps_cpp::_CMRemoteControl_Event__handle;
}
...
static const rosidl_service_type_support_t _CMRemoteControl__handle{
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_CMRemoteControl__callbacks,
  get_service_typesupport_handle_function,
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<cmrosutils::srv::CMRemoteControl_Request>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<cmrosutils::srv::CMRemoteControl_Response>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<cmrosutils::srv::CMRemoteControl_Event>(),
