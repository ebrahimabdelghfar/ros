...
class Init_CMRemoteControl_Event_response
{
public:
  explicit Init_CMRemoteControl_Event_response(::cmrosutils::srv::CMRemoteControl_Event & msg)
  : msg_(msg)
  {}
  ::cmrosutils::srv::CMRemoteControl_Event response(::cmrosutils::srv::CMRemoteControl_Event::_response_type arg)
  {
...
private:
  ::cmrosutils::srv::CMRemoteControl_Event msg_;
};

class Init_CMRemoteControl_Event_request
{
public:
  explicit Init_CMRemoteControl_Event_request(::cmrosutils::srv::CMRemoteControl_Event & msg)
  : msg_(msg)
  {}
  Init_CMRemoteControl_Event_response request(::cmrosutils::srv::CMRemoteControl_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_CMRemoteControl_Event_response(msg_);
  }
...
class Init_CMRemoteControl_Event_info
{
public:
  Init_CMRemoteControl_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_CMRemoteControl_Event_request info(::cmrosutils::srv::CMRemoteControl_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_CMRemoteControl_Event_request(msg_);
  }
...
template<>
inline
auto build<::cmrosutils::srv::CMRemoteControl_Event>()
{
  return cmrosutils::srv::builder::Init_CMRemoteControl_Event_info();
}
