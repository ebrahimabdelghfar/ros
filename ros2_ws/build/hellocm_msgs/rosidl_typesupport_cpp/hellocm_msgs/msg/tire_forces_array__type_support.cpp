...
static const _TireForcesArray_type_support_symbol_names_t _TireForcesArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, hellocm_msgs, msg, TireForcesArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, hellocm_msgs, msg, TireForcesArray)),
  }
};
...
{
  return &::hellocm_msgs::msg::rosidl_typesupport_cpp::TireForcesArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, hellocm_msgs, msg, TireForcesArray)() {
  return get_message_type_support_handle<hellocm_msgs::msg::TireForcesArray>();
}
