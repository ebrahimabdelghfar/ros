...
static const _Init_Event_type_support_symbol_names_t _Init_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, hellocm_msgs, srv, Init_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, hellocm_msgs, srv, Init_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, hellocm_msgs, srv, Init_Event)() {
  return &::hellocm_msgs::srv::rosidl_typesupport_c::Init_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t Init_service_type_support_handle = {
  ...
  &Init_Request_message_type_support_handle,
  &Init_Response_message_type_support_handle,
  &Init_Event_message_type_support_handle,
