...
//#  include "hellocm/ROS1_HelloCM.h"  /* External ROS Node. Topic name, ... */
  ...
  #include "hellocm_msgs/msg/tire_steering.hpp"
  #include "hellocm_msgs/msg/tire_forces.hpp"
  #include "hellocm_msgs/msg/tire_forces_array.hpp"
...
class CMNodeHelloCM : public CarMakerROSInterface {
 ...
 private:
  ...
  /**
   * @brief odomFillMsg prepares the ground truth odometry message 
   * to be transmitted from CarMaker over ROS.
   * @param msg the actual message being prepared by this function
   */
  ...
  /**
   * @brief tireSteeringFillMsg prepares the tire steering angle message 
   * to be transmitted from CarMaker over ROS.
   * @param msg the actual message being prepared by this function
   */
  void tireSteeringFillMsg(hellocm_msgs::msg::TireSteering& msg);

  /**
   * @brief tireForcesFillMsg prepares the tire forces message (Pacejka ground truth)
   * to be transmitted from CarMaker over ROS.
   * @param msg the actual message being prepared by this function
   */
  void tireForcesFillMsg(hellocm_msgs::msg::TireForcesArray& msg);
